...
func Test_ConsoleErrorFormatter(t *testing.T) {
	...
	testDataPool := []struct {
		...
		},
		{
			...
			"github.com/tmsong/utils/error/ConsoleFormatter_test.go lasterror",
			false,
			"LongFile",
		},
		{
		...
		},
		{
			...
			"github.com/tmsong/utils/error/ConsoleFormatter_test.go lasterror; childerror1; childerror2",
			false,
			"Seperator|LongFile",
		},
		{
		...
		},
		{
			...
			"github.com/tmsong/utils/error/ConsoleFormatter_test.go:19 lasterror; childerror1; childerror2",
			false,
